...
class Faq extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['faqs'] = $this->faqModels->findAll();
    ...
    public function save()
    {
        ...
        if ($this->validation->run($data, 'faq')) {
            ...
            // Show modal session to shown up modal form if validation is wrong
            // Initialization of this function can be seen in App/Helper/ValidationSet_helper.php
            setModalValidation('#add-faq-modal', false, $id);
